...
export class TransactionsV2Service {
    ...
    async updateTransaction(idTrans: string, status: string, data: any, type?: string) {
        ...
        if (getDataTransaction.length > 0) {
            for (let uh = 0; uh < getDataTransaction.length; uh++) {
                ...
                await this.transactionsModel.findByIdAndUpdate({ idTransaction: dataTransaction._id.toString() }, transactionsV2_, { new: true });
            }
        }
    ...
    async getdetailtransaksinewincoince2(idtransaction: string) {
        ...
        let setoutput = {
            ...
            noInvoice: data[0].noInvoice,
            category: data[0].category,
            product: data[0].product,
            voucherDiskon: data[0].voucherDiskon,
            idUser: data[0].idUser,
            coinDiscount: data[0].coinDiscount,
            coin: data[0].coin,
            totalCoin: data[0].totalCoin,
            priceDiscont: data[0].priceDiscont,
            price: data[0].price,
            totalPrice: data[0].totalPrice,
            createdAt: data[0].createdAt,
            updatedAt: data[0].updatedAt,
            typeCategory: data[0].typeCategory,
            typeUser: data[0].typeUser,
            va_number: data[0].va_number,
            idStream: data[0].idStream,
            code: data[0].code,
            namePaket: data[0].namePaket,
            coa: data[0].coa,
            coaDetailName: data[0].coaDetailName,
            coaDetailStatus: data[0].coaDetailStatus,
            post_id: data[0].post_id,
            credit: data[0].credit,
            boost_type: data[0].boost_type,
            boost_interval: data[0].boost_interval,
            boost_unit: data[0].boost_unit,
            boost_start: data[0].boost_start,
            status: data[0].status,
            expiredtimeva: data[0].expiredtimeva,
            idtr_lama: data[0].idtr_lama,
            post_type: data[0].post_type,
            withdrawAmount: data[0].withdrawAmount,
            withdrawTotal: data[0].withdrawTotal,
            withdrawCost: data[0].withdrawCost,
            adType: data[0].adType,
            titleStream: data[0].titleStream,
