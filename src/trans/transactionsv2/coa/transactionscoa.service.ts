...
export class TransactionsCoaService {
    ...
    async findOneIdTransaction(idTransaction: string): Promise<TransactionsCoa> {
        return await this.transactionsCoaModel.findOne({ idTransaction: idTransaction }).exec();
    }
